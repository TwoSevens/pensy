...
use crate::db::repositories::knowledge as repository;
...
pub fn create_knowledge_note(
    ...
    repository::create_knowledge_note(&vault.database, &title)
        .map_err(|e| format!("Could not create knowledge note: {}", e))
}
