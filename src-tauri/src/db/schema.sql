...
-- Journal content update
CREATE TRIGGER update_note_after_journal_content_update
AFTER UPDATE ON journal_content
FOR EACH ROW
BEGIN
    UPDATE notes
...
CREATE TRIGGER update_note_after_journal_content_insert
...
-- People updates
CREATE TRIGGER update_note_after_journal_content_update
AFTER UPDATE ON people_nicknames
FOR EACH ROW
BEGIN
    UPDATE notes
    SET updated_at = DATETIME('now')
...
CREATE TRIGGER update_note_after_journal_content_update
AFTER UPDATE ON people_contact_info
FOR EACH ROW
BEGIN
    UPDATE notes
    SET updated_at = DATETIME('now')
...
CREATE TRIGGER update_note_after_journal_content_update
AFTER UPDATE ON people_physical_traits
FOR EACH ROW
BEGIN
    UPDATE notes
    SET updated_at = DATETIME('now')
...
CREATE TRIGGER update_note_after_journal_content_update
AFTER UPDATE ON people_behavioral_traits
FOR EACH ROW
BEGIN
    UPDATE notes
    SET updated_at = DATETIME('now')
...
CREATE TRIGGER update_note_after_journal_content_update
AFTER UPDATE ON people_impression_over_time
FOR EACH ROW
BEGIN
    UPDATE notes
    SET updated_at = DATETIME('now')
...
BEGIN
    UPDATE notes
    SET updated_at = DATETIME('now')
    WHERE notes.note_id = NEW.note_id_a;

    UPDATE notes
    SET updated_at = DATETIME('now')
    WHERE notes.note_id = NEW.note_id_b;
END;
